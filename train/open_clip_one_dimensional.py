...
def start_train():
    ...
    model_scene = OneDimensionalCNN(in_channels=512, out_channels=512, kernel_size=5, input_size=512, feature_size=output_feature_size)
    ...
    is_token_level = True
    is_synosis = False
    ret_data = train_utilities.get_entire_data(clip_ones=True, token_level=is_token_level, is_synopsis=is_synosis, is_tag_need=False)
    ...
    dataset = DescriptionSceneDataset(data_description_,
                                         data_scene_,
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        #     new_content = 'evaluation started'
        #     file.write("\n" + new_content)
        ...
        # file_path = './processed_index.txt'
        # with open(file_path, 'a') as file:
        #     new_content = 'evaluation finished'
        #     file.write("\n" + new_content)
