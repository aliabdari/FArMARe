...
def start_train():
    ...
    model_scene = FCNet(input_size=2048, feature_size=output_feature_size)
    ...
    # Loading Data
    is_token_level = True
    ret_data = train_utilities.get_entire_data(clip_ones=False, is_synopsis=False, token_level=is_token_level, is_tag_need=False)
    ...
    dataset = DescriptionSceneDataset(data_description_, data_scene_, type_model_scene="mean")
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        if r10 > best_r10:
            best_r10 = r10
            train_utilities.save_best_model(model_scene.state_dict(), model_descriptor.state_dict(), 'resnet_mean.pt')
    ...
    best_model_state_dict_scene, best_model_state_dict_description = train_utilities.load_best_model('resnet_mean.pt')
    ...
    train_utilities.write_models_evaluation_to_file([ds1, ds5, ds10, sd1, sd5, sd10, ndgc_10, ndcg, ds_medr, sd_medr],
                                                    'resnet_mean' + "_test_evaluate" + ".txt")
