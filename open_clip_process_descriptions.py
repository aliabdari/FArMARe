...
path_descriptions = 'description_sentences'
...
for jf in tqdm(list_txt_files):
    ...
    with torch.no_grad(), torch.cuda.amp.autocast():
        ...
        torch.save(features_sentences, f'./open_clip_features/descriptions/sentences/{file_name}.pt')

        features_tokens = features_tokens.cpu()
        torch.save(features_tokens, f'./open_clip_features/descriptions/tokens/{file_name}.pt')
        with open(f'./open_clip_features/descriptions/tokens_strings/{file_name}.pkl', 'wb') as f:
