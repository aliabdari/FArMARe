...
def start_train():
    ...
    model_scene = OneDimensionalCNNVClassifier(in_channels=2048, out_channels=512, kernel_size=5, input_size=512,
    ...
    dataset = DescriptionSceneDatasetMemClassifier(data_description_path=data_description_,
